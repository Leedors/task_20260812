...
public sealed class JoinedDateTests
{
    ...
    public void ISO8601_전체_표기도_해석한다()
    {
        ...
        parsed.Should().BeTrue();
        value.Should().Be(new DateOnly(2018, 3, 7));
    }
